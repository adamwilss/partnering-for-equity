        ...
        <div className="grid md:grid-cols-3 gap-6">
          {reasons.map((reason, i) => (
            <RevealBlock key={i} delay={i * 0.15}>
              <div className="p-6 rounded-2xl bg-slate-100 border border-slate-200 hover:border-indigo-500/20 hover:bg-slate-50 transition-all duration-300 h-full">
                <h3 className="text-slate-900 font-semibold mb-3">{reason.heading}</h3>
  ...
  return (
    <SectionWrapper id="1.3">
      ...
      <div className="relative z-10 max-w-4xl mx-auto">
        <RevealBlock>
          <AssembleText text="Our Partnering for Equity model" className="text-2xl sm:text-3xl md:text-4xl font-bold text-slate-900 tracking-tight mb-6" />
        </RevealBlock>
        <RevealBlock delay={0.15}>
          <div className="p-8 rounded-2xl bg-slate-100 border border-slate-200">
            <p className="text-slate-500 text-base md:text-lg leading-relaxed whitespace-pre-line">{body}</p>
          </div>
        </RevealBlock>
...
function Section1_4() {
  ...
  return (
    <SectionWrapper id="1.4">
      ...
      <div className="relative z-10">
        <RevealBlock>
          <AssembleText text="The main benefits for you of partnering with us" className="text-2xl sm:text-3xl md:text-4xl font-bold text-slate-900 tracking-tight mb-4" />
        </RevealBlock>
        <RevealBlock delay={0.1}>
          <p className="text-slate-500 text-base md:text-lg mb-8 max-w-3xl">
...
function Section1_5() {
  ...
  return (
    <SectionWrapper id="1.5">
      ...
      <div className="relative z-10">
        <RevealBlock>
          <AssembleText text="Our Role" className="text-2xl sm:text-3xl md:text-4xl font-bold text-slate-900 tracking-tight mb-4" />
        </RevealBlock>
        <RevealBlock delay={0.1}>
          <p className="text-slate-500 text-base md:text-lg mb-8 max-w-3xl">
...
function Section1_6() {
  ...
  return (
    <SectionWrapper id="1.6">
      ...
      <div className="relative z-10 max-w-4xl mx-auto">
        <RevealBlock>
          <AssembleText text="Why should we help you?" className="text-2xl sm:text-3xl md:text-4xl font-bold text-slate-900 tracking-tight mb-6" />
        </RevealBlock>
        <RevealBlock delay={0.15}>
          <div className="p-8 rounded-2xl bg-slate-100 border border-slate-200">
            <p className="text-slate-500 text-base md:text-lg leading-relaxed whitespace-pre-line">{body}</p>
...
function Section1_7() {
  ...
  return (
    <SectionWrapper id="1.7">
      ...
      <div className="relative z-10">
        <RevealBlock>
          <AssembleText text="The Issues We Solve" className="text-2xl sm:text-3xl md:text-4xl font-bold text-slate-900 tracking-tight mb-4" />
        </RevealBlock>
        <RevealBlock delay={0.1}>
          <p className="text-slate-500 text-base md:text-lg mb-8 max-w-3xl">
        ...
        <RevealBlock delay={0.35}>
          <div className="mt-8 p-6 rounded-xl bg-indigo-500/[0.03] border border-indigo-500/10">
            <p className="text-slate-500 text-sm leading-relaxed">{closing}</p>
          </div>
        </RevealBlock>
...
function Section1_8() {
  ...
  return (
    <SectionWrapper id="1.8">
      ...
      <div className="relative z-10 max-w-4xl mx-auto">
        <RevealBlock>
          <AssembleText text="Gaining Equity Stakes before we Acquire Them" className="text-2xl sm:text-3xl md:text-4xl font-bold text-slate-900 tracking-tight mb-6" />
        </RevealBlock>
        <RevealBlock delay={0.15}>
          <div className="p-8 rounded-2xl bg-slate-100 border border-slate-200">
            <p className="text-slate-500 text-base md:text-lg leading-relaxed whitespace-pre-line">{body}</p>
...
function Section1_9() {
  ...
  return (
    <SectionWrapper id="1.9">
      ...
      <div className="relative z-10 max-w-4xl mx-auto">
        <RevealBlock>
          <AssembleText text="Become the Author of a book helping business sellers" className="text-2xl sm:text-3xl md:text-4xl font-bold text-slate-900 tracking-tight mb-6" />
        </RevealBlock>
        <RevealBlock delay={0.15}>
          <div className="p-8 rounded-2xl bg-slate-100 border border-slate-200">
            <p className="text-slate-500 text-base md:text-lg leading-relaxed whitespace-pre-line">{body}</p>
            <a
              ...
              className="inline-flex items-center mt-6 text-indigo-600 hover:text-indigo-400 font-medium text-sm transition-colors"
            >
              {linkLabel}
    ...
    <>
      <section className="relative py-24 md:py-32 px-4 sm:px-6 lg:px-8 overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto text-center">
          <RevealBlock>
            <AssembleText text="Why you Should Join us" className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-slate-900 tracking-tight mb-6" />
          </RevealBlock>
          <RevealBlock delay={0.15}>
