          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
              ...
              <div className="relative">
                <div className="w-full h-80 rounded-[4rem] bg-gradient-to-br from-rose-500/10 to-pink-500/10 border border-rose-500/10 flex items-center justify-center">
                  <div className="text-center p-8">
                    ...
                    <p className="text-rose-300/50 text-sm">David Hargraves, Chairman of Blue Sky Group</p>
                  </div>
                </div>
            ...
            <RevealBlock direction="left" delay={0.2}>
              <h2 className="text-3xl md:text-4xl font-bold text-white mb-6 tracking-tight">
                Why We{" "}
                <span className="text-rose-400">Started</span>
              </h2>
        ...
        <div className="max-w-5xl mx-auto">
          <RevealBlock>
            <h2 className="text-3xl md:text-4xl font-bold text-white text-center mb-12 tracking-tight">
              Panel of{" "}
              <span className="text-rose-400">Experts & Advisors</span>
            </h2>
          </RevealBlock>
          ...
          <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-4">
            {[
              ...
              <motion.div
                ...
                className="p-4 rounded-xl bg-white/[0.01] border border-white/[0.03] hover:border-rose-500/10 transition-all duration-300"
              >
                <h3 className="text-white font-semibold text-sm">{person.name}</h3>
                <p className="text-white/30 text-xs mt-1">{person.role}</p>
              </motion.div>
            ))}
          </div>
        </div>
