  ...
  return (
    <div className="grid sm:grid-cols-2 gap-6">
      {benefits.map((benefit) => (
        <div
          key={benefit.title}
          className="group p-6 rounded-2xl bg-slate-100 border border-slate-200 hover:border-indigo-500/20 hover:bg-slate-50 transition-all duration-300"
        >
      ...
      >
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-start">
          <div>
            ...
            <p className="text-slate-900/50 leading-relaxed text-base md:text-lg mb-8">
              {subtitle}
            </p>
